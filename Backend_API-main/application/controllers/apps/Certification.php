...
class Certification extends CI_Controller
{
    ...
    public function __construct()
    {
       ...
       // $this->load->model("web/Certification_model", "", true);
		$this->load->model("apps/Certification_model", "", true);
    ...
    public function getlistofCertificate()
    {
        ...
        $result = $this->Certification_model->getlistofCertificate($courseCatId);
		
		//print_r($result);exit;
		
		  foreach ($result as &$certificateDetails) {
            $certificateDetails->image = base_url() . "uploads/certificate/" . $certificateDetails->image;
        }
		//print_r($result);exit;
        if ($result) {
