...
class Campus_app extends CI_Controller
{
    ...
    /*public function getCollegeListByRank()
    {
        ...
        if ($data) {
            ...
            $result = $this->Campus_app_model->getCollegesListByRanks($id);
	...
	public function getCollegeListByRank()
    {
       // echo "tttt";exit;
        ...
        if ($data) {
            ...
            $result = $this->Campus_app_model->getCollegesListByRanks($courseId);
           //  print_r($result);exit;

            foreach ($result as &$clg) {
                $TotalRate = $this->Review_model->getCollegeTotalRate($clg->collegeid);
				$courseCount = $this->Campus_app_model->countCoursesByCourseId($courseId, $clg->collegeid);
