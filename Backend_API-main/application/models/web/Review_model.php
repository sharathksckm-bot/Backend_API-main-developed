...
class Review_model extends CI_Model
{
    ...
    {
        $this->db->select("r.*,  CONCAT(u.f_name,' ',u.l_name) as reviewedByName,cr.name as coursename") ;
        ...
        $this->db->join('courses cr', 'cr.id = r.course_id','left');
...
function TotalComments($collegeid)
{
    $this->db->select('count(question_id) as count_of_qa');
